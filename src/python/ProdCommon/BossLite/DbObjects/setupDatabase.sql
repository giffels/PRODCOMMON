...
CREATE TABLE bl_runningjob
  (
    ...
    status_history TEXT,
    destination TEXT,
    lb_timestamp TIMESTAMP DEFAULT 0,
    submission_time TIMESTAMP DEFAULT 0,
    start_time TIMESTAMP DEFAULT 0,
    stop_time TIMESTAMP DEFAULT 0,
    output_dir TEXT,
    getoutput_time TIMESTAMP DEFAULT 0,
    execution_host TEXT,
    execution_path TEXT,
    ...
    sched_attr TEXT,
    process_status enum('not_handled', 'handled', 'failed', 'failure_handled',
                        'output_requested','in_progress','output_retrieved',
			'processed') default 'not_handled',
